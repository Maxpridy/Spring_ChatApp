...
public class ChatSqls {
	...
	static final String SELECT_ALL = 
			"SELECT id, chatName, chatContent, date FROM chat";
	static final String SELECT_BY_ID = 
			"SELECT id, chatName, chatContent, date FROM chat WHERE id = :id";
	static final String SELECT_BY_COMPLETED = 
			"SELECT id, chatName, chatContent, date FROM chat WHERE name= :name";
